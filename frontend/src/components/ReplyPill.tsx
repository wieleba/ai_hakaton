...
export const ReplyPill: React.FC<Props> = ({ authorUsername, textPreview, onDismiss }) => (
  <div className="flex items-center gap-2 bg-blue-50 border border-blue-200 rounded px-3 py-1 text-xs dark:bg-discord-accent/20 dark:border-discord-accent/50 dark:text-discord-text">
