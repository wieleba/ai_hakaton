    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <div className="bg-white shadow p-4 border-b">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <button onClick={handleLeaveRoom} className="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Leave Room</button>
        </div>
      </div>

      <div className="flex h-full flex-1 max-w-6xl mx-auto w-full">
        <div className="flex-1 flex flex-col min-w-0">
          <MessageList messages={messages} isLoading={false} hasMore={true} onLoadMore={loadMoreMessages} />
